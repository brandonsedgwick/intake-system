      ...
      <div className="max-w-md w-full space-y-8 p-8">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg text-sm">
            {error === "AccessDenied"
              ? "Access denied. Please use your authorized Google Workspace account."
        ...
        <p className="text-center text-xs text-gray-500 mt-8">
          This system is for authorized practice staff only.
          <br />
          By signing in, you agree to comply with HIPAA guidelines.
        </p>
      </div>
    </div>
  );
